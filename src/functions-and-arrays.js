...
function sum(mixedArray) {
  ...
  for (let i = 0; i < mixedArray.length; i++) {
    ...
    if (typeof mixedArray[i] === "string") {
      answer += mixedArray[i].length;
    }

    if (typeof mixedArray[i] === "boolean" && mixedArray[i] === true) {
      answer += 1;
    }
...
function averageNumbers(numbersAvg) {
  ...
  let answer = sum / numbersAvg.length;
...
function averageWordLength(wordsArr) {
  ...
  answer = sumWords / wordsArr.length;
...
function avg(averageArray) {
  ...
  let sumArray = sum(averageArray);
  let answer = sumArray / averageArray.length;
